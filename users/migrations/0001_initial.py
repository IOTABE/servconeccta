    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('client', 'Cliente'), ('professional', 'Profissional'), ('admin', 'Administrador')], db_index=True, default='client', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pendente'), ('active', 'Ativo'), ('inactive', 'Inativo'), ('suspended', 'Suspenso')], db_index=True, default='pending', max_length=20)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['status', 'user'], name='professiona_status_fa1861_idx'),
        ),
        migrations.AddIndex(
            model_name='professionalprofile',
            index=models.Index(fields=['city', 'state'], name='professiona_city_376309_idx'),
        ),
        migrations.AddIndex(
            model_name='professionalprofile',
            index=models.Index(fields=['latitude', 'longitude'], name='professiona_latitud_7d4228_idx'),
        ),
    ]
